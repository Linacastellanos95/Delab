...
builder.Services.AddSwaggerGen(c =>
{
    ...
    c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
    {
        Description = @"JWT Authorization header using the Bearer scheme. <br /> <br />
                      Enter 'Bearer' [space] and then your token in tghe text input below.<br /> <br />
...
app.UseSwagger();
app.UseSwaggerUI();
string swaggerUrl = "https://localhost:7042/swagger"; //URL de Swagger
